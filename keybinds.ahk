...
!+':: self_insert_command()
!+\:: self_insert_command()
!+z:: command_simple("!z", 0, 0)
!+x:: self_insert_command()
!+c:: self_insert_command()
!+v:: self_insert_command()
!+b:: self_insert_command()
!+n:: self_insert_command()
!+m:: command_simple("!m", 0, 0)
!+,:: beginning_of_buffer()
!+.:: end_of_buffer()
!+/:: self_insert_command()
...
^+-:: undo_only()
^+=:: self_insert_command()
^+q:: command_simple("^q", 0, 0)
^+w:: self_insert_command()
^+e:: self_insert_command()
^+r:: self_insert_command()
^+t:: self_insert_command()
^+y:: command_simple("^y", 0, 0)
^+u:: command_simple("^u", 0, 0)
^+i:: command_simple("^i", 0, 0)
^+o:: self_insert_command()
^+p:: self_insert_command()
^+[:: self_insert_command()
^+]:: self_insert_command()
^+a:: command_simple("^a", 0, 0)
^+s:: self_insert_command()
^+d:: self_insert_command()
^+f:: self_insert_command()
^+g:: command_simple("^g", 0, 0)
^+h:: self_insert_command()
^+j:: self_insert_command()
^+k:: command_simple("^k", 0, 0)
^+l:: self_insert_command()
^+`;:: self_insert_command()
^+':: self_insert_command()
^+\:: self_insert_command()
;; ^+z:: self_insert_command()
^+x:: command_simple("^x", 0, 0)
;; ^+c:: self_insert_command()
;; ^+v:: command_simple("^v", 0, 0)
^+b:: command_simple("^b", 0, 0)
^+n:: self_insert_command()
^+m:: self_insert_command()
^+,:: self_insert_command()
^+.:: self_insert_command()
